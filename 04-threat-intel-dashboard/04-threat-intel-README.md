...
[
    {
        ...
        "type": "ip",
        "intel": {
            "abuseipdb": { "abuseConfidenceScore": 100, "totalReports": 254 },
            "virustotal": { "malicious": 12, "total": 72 },
            "otx": { "pulse_count": 3, "threat_names": ["Mirai-Variant", "Brute-Force-List"] },
            "shodan": { "open_ports": [23, 80, 8080] }
        },
    ...
    },
    {
        ...
        "type": "cve",
        "intel": {
            "epss": { "epss": "94.12%", "percentile": "0.987" },
            "otx": { "pulse_count": 12, "threat_names": ["HTTP/2 Rapid Reset Campaign"] }
        },
