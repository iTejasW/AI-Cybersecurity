...
- **CVE Analysis** — Fetch CVE details and generate AI-powered threat briefs
- **Phishing Investigation** — Parse `.eml` files and analyze indicators
- **Threat Intelligence** — Enrich IPs, domains, and hashes using VirusTotal, AbuseIPDB, and Shodan
- **Tool Chaining** — Automatically trigger follow-up investigations
